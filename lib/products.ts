...
export const products: Product[] = [
  ...
  {
    id: "11",
    name: "Peptide Vault Advanced Peptide Supplement",
    category: "Health Supplements",
    price: 54.99,
    originalPrice: 79.99,
    image: "/g11.png",
    description: "Advanced Peptide Supplement formula featuring a comprehensive research-backed blend. High purity, made in USA.",
    rating: 4.9,
    reviews: 89,
    inStock: true,
